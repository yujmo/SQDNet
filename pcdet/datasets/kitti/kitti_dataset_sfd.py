...
class KittiDatasetSFD(DatasetTemplate):
    ...
    def process_data_random_sample(self, image_shape_ori, cu, cv, fu, fv, tx, ty, P2, R0, V2C, image, raw_points,
                                   dense_depth):
        ...
        shuffle_idx = np.random.permutation(pc_velo_intensity_rgb_uv.shape[0])
        pc_velo_intensity_rgb_uv = pc_velo_intensity_rgb_uv[shuffle_idx][:20000, :]

        return pc_velo_intensity_rgb_uv, pc_velo_intensity_rgb_uv.cpu().numpy()
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        ROOT_DIR = Path('/moyujian/moyujian/Data/yujmo/KITTI/kitti_sfd_seguv_twise')
        create_kitti_infos(
