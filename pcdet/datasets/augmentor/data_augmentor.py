...
class DataAugmentor(object):
    ...
    def random_world_flip_sfd(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            assert cur_axis in ['x', 'y']
            gt_boxes, points = getattr(augmentor_utils_sfd, 'random_flip_along_%s' % cur_axis)(
                gt_boxes, points
            )
    ...
    def random_world_rotation_sfd(self, data_dict=None, config=None):
        ...
        if not isinstance(rot_range, list):
            rot_range = [-rot_range, rot_range]
        gt_boxes, points = augmentor_utils_sfd.global_rotation(
            data_dict['gt_boxes'], data_dict['points'], rot_range=rot_range
        )
    ...
    def random_world_scaling_sfd(self, data_dict=None, config=None):
        ...
        gt_boxes, points = augmentor_utils_sfd.global_scaling(
            data_dict['gt_boxes'], data_dict['points'], config['WORLD_SCALE_RANGE']
        )
        data_dict['gt_boxes'] = gt_boxes
        data_dict['points'] = points
    ...
    def random_local_noise_sfd(self, data_dict=None, config=None):
        ...
        augmentor_utils_sfd.noise_per_object_v3_(data_dict['gt_boxes'], data_dict['points'],
